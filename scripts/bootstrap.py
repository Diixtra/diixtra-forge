...
def install_cilium_cni(config: Config) -> None:
    ...
    helm_install = [
        ...
        "--set", "hubble.ui.frontend.resources.requests.cpu=1m",
        "--set", "hubble.ui.frontend.resources.requests.memory=10Mi",
        "--set", "hubble.ui.frontend.resources.limits.cpu=100m",
        "--set", "hubble.ui.frontend.resources.limits.memory=64Mi",
        "--set", "hubble.ui.backend.resources.requests.cpu=10m",
        "--set", "hubble.ui.backend.resources.requests.memory=32Mi",
        "--set", "hubble.ui.backend.resources.limits.cpu=250m",
        "--set", "hubble.ui.backend.resources.limits.memory=256Mi",
